...
import info.sanaebadi.tddandroidunittest.ui.note.NoteViewModel.ViewState
import info.sanaebadi.tddandroidunittest.util.DateUtil
import info.sanaebadi.tddandroidunittest.util.LinedEditText
...
class NoteActivity : DaggerAppCompatActivity(), OnTouchListener,
    ...
    private fun subscribeObservers() {
        viewModel!!.observeNote().observe(
            this,
            Observer { note -> setNoteProperties(note) })
    ...
    private fun enableEditMode() {
        ...
        viewModel!!.setViewState(ViewState.EDIT)
    }

    private fun disableEditMode() {
        Log.d(TAG, "disableEditMode: called.")
        viewModel!!.setViewState(ViewState.VIEW)
